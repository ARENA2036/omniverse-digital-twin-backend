...
**Extension Name:** `arena2036.usd_explorer_filters`  
**Version:** 1.0.0  
**Category:** UI
...
*   **Livestream Integration**: Listens for external `ToggleFilter` events to allow remote control.

## Installation & Usage

1.  **Load the Extension**: Enable `arena2036.usd_explorer_filters` in the Omniverse Extension Manager.
...
**File Location:** `arena2036/usd_explorer_filters/prim_info.csv`
